...
const NEW_NOTES: Array<{ id: string; topicId: string; title: string; contentMd: string }> = [
  {
    id: 'bio-n-09',
    topicId: 'bio-t-01',
    title: 'Ch 1 — Evolution, Themes & Scientific Inquiry',
    contentMd: N09_CH1,
  },
  {
    id: 'bio-n-10',
    topicId: 'bio-t-02',
    title: 'Ch 2 — Chemical Context of Life',
    contentMd: N10_CH2,
  },
  { id: 'bio-n-11', topicId: 'bio-t-22', title: 'Ch 3 — Water and Life', contentMd: N11_CH3 },
  {
    id: 'bio-n-12',
    topicId: 'bio-t-23',
    title: 'Ch 4 — Carbon & Molecular Diversity',
    contentMd: N12_CH4,
  },
  { id: 'bio-n-13', topicId: 'bio-t-24', title: 'Ch 6 — A Tour of the Cell', contentMd: N13_CH6 },
  {
    id: 'bio-n-14',
    topicId: 'bio-t-07',
    title: 'Ch 7 — Membrane Structure & Function',
    contentMd: N14_CH7,
  },
  {
    id: 'bio-n-15',
    topicId: 'bio-t-10',
    title: 'Ch 9 — Respiration Pathways & Figures',
    contentMd: N15_CH9_FIGS,
  },
  {
    id: 'bio-n-16',
    topicId: 'bio-t-11',
    title: 'Ch 12 — Cell Cycle & Mitosis',
    contentMd: N16_CH12,
  },
  {
    id: 'bio-n-17',
    topicId: 'bio-t-14',
    title: 'Ch 13 — Meiosis & Sexual Life Cycles',
    contentMd: N17_CH13,
  },
  {
    id: 'bio-n-18',
    topicId: 'bio-t-13',
    title: 'Ch 16 — Molecular Basis of Inheritance',
    contentMd: N18_CH16,
  },
  {
    id: 'bio-n-19',
    topicId: 'bio-t-17',
    title: 'Ch 17 — From Gene to Protein',
    contentMd: N19_CH17,
  },
  ...
  { id: 'bio-n-21', topicId: 'bio-t-15', title: 'Ch 20 — Biotechnology', contentMd: N21_CH20 },
  {
    id: 'bio-n-22',
    topicId: 'bio-t-25',
    title: 'Ch 40 — Animal Form & Function',
    contentMd: N22_CH40,
  },
  {
    id: 'bio-n-23',
    topicId: 'bio-t-06',
    title: 'Ch 41 — Nutrition & Digestion',
    contentMd: N23_CH41,
  },
  {
    id: 'bio-n-24',
    topicId: 'bio-t-18',
    title: 'Ch 42 — Circulatory System',
    contentMd: N24_CH42_CIRC,
  },
  {
    id: 'bio-n-25',
    topicId: 'bio-t-08',
    title: 'Ch 42 — Respiratory System',
    contentMd: N25_CH42_RESP,
  },
  ...
  { id: 'bio-n-29', topicId: 'bio-t-26', title: 'Ch 46 — Reproduction', contentMd: N29_CH46 },
  {
    id: 'bio-n-30',
    topicId: 'bio-t-27',
    title: 'Ch 48 — Neurons, Synapses & Signaling',
    contentMd: N30_CH48,
  },
  {
    id: 'bio-n-31',
    topicId: 'bio-t-20',
    title: 'Ch 49 — Nervous System Organization',
    contentMd: N31_CH49,
  },
  {
    id: 'bio-n-32',
    topicId: 'bio-t-28',
    title: 'Ch 50 — Sensory & Motor Mechanisms',
    contentMd: N32_CH50,
  },
]
...
const QUIZ_DECKS: Deck[] = [
  {
    ...
    cards: [
      {
        front: 'What are the eight properties shared by all living things?',
        back: 'Order, Evolutionary adaptation, Response to environment, Regulation (homeostasis), Energy processing, Growth & development, Reproduction, Biological evolution. Mnemonic: OERREGR + Evolution.',
      },
      {
        front: "What are Darwin's four key components of natural selection?",
        back: '1. Variation — heritable differences exist in populations\n2. Overproduction — more offspring than can survive\n3. Differential survival/reproduction — individuals with favorable traits survive more\n4. Adaptation — favorable traits increase in frequency over generations',
      },
      {
        front: 'List the levels of biological organization from atom to biosphere.',
        back: 'Atom → Molecule → Organelle → Cell → Tissue → Organ → Organ System → Organism → Population → Community → Ecosystem → Biosphere',
      },
      {
        front: 'What is the difference between inductive and deductive reasoning?',
        back: 'Inductive: specific observations → broad generalization (used to form hypotheses)\nDeductive: general principle → specific prediction (used to test hypotheses)\nBoth are used in science; deductive produces "if-then" predictions from a hypothesis.',
      },
      {
        front: 'What are the three subatomic particles and their charges/locations?',
        back: 'Protons (+1) — nucleus; define the element (atomic number)\nNeutrons (0) — nucleus; contribute to mass number\nElectrons (−1) — orbitals; determine bonding and reactivity',
      },
      {
        front: 'What are isotopes? Give a biological example.',
        back: 'Isotopes: atoms of the same element with different numbers of neutrons (same atomic number, different mass number).\nExamples: ¹²C vs ¹⁴C (carbon dating), ³²P (labels DNA), ¹⁸O (tracing water/O₂ in photosynthesis).',
      },
      {
        front: 'Define electronegativity and rank O, N, C, H from highest to lowest.',
        back: "Electronegativity = an atom's ability to attract shared electrons in a covalent bond.\nRanking: O > N > C ≈ H\nWhen O bonds to H, electrons spend more time near O → partial charges (δ− on O, δ+ on H) → polar bond.",
      },
      {
        front: 'Compare ionic, covalent, and hydrogen bonds.',
        back: 'Ionic: electron TRANSFER; forms ions; broken in water (NaCl)\nCovalent: electron SHARING; strongest biological bond; polar (unequal) or nonpolar (equal) sharing\nHydrogen: weak attraction between δ+ H and δ− O or N on nearby molecule; individually weak but collectively important',
      },
      {
        front: 'What is the octet rule and why is it important in biology?',
        back: 'Atoms tend to gain, lose, or share electrons to achieve 8 electrons in their outermost (valence) shell.\nImportance: determines how many bonds an atom forms (C forms 4, N forms 3, O forms 2, H forms 1). Explains covalent bonding in organic molecules.',
      },
      {
        front: 'What is the difference between a polar covalent bond and a nonpolar covalent bond?',
        back: 'Nonpolar covalent: electrons shared equally (between same or similar atoms, e.g., C–C, C–H). Hydrophobic.\nPolar covalent: electrons shared unequally due to electronegativity difference (e.g., O–H, N–H). Creates partial charges. Hydrophilic.',
      },
      {
        front: 'How many valence electrons does carbon have, and what does this mean for bonding?',
        back: 'Carbon has 4 valence electrons → forms 4 covalent bonds. It can bond to H, O, N, S, and other C atoms in chains, branches, or rings — creating the enormous structural diversity of organic molecules.',
      },
      {
        front: 'What is a hypothesis vs. a theory in science?',
        back: 'Hypothesis: a specific, testable, falsifiable explanation for an observation (an educated guess).\nTheory: a broad, well-substantiated explanation supported by extensive evidence and repeated testing (e.g., cell theory, evolutionary theory). NOT a guess — a theory is the highest level of scientific understanding.',
      },
      {
        front: 'What is the difference between a control group and an experimental group?',
        back: 'Experimental group: exposed to the independent variable being tested.\nControl group: identical in all ways EXCEPT the independent variable; provides a baseline for comparison.\nBoth groups are treated identically otherwise to isolate the effect of the independent variable.',
      },
      {
        front: 'What is radioactive carbon-14 (¹⁴C) dating and what is it used for?',
        back: '¹⁴C is a radioactive isotope of carbon incorporated into living organisms from CO₂. When an organism dies, ¹⁴C decays at a known rate (half-life = 5,730 years). By measuring remaining ¹⁴C, scientists can date organic materials up to ~50,000 years old.',
      },
      {
        front: 'What is van der Waals interaction and when is it biologically significant?',
        back: 'Weak, transient attractions between nonpolar molecules due to temporary dipoles caused by electron movement.\nSignificant when many are present simultaneously (e.g., hydrophobic interactions in proteins, gecko feet adhesion, packing of hydrophobic tails in membranes).',
      },
    ],
  },
  {
    ...
    cards: [
      {
        front: 'What are the four emergent properties of water that make it vital for life?',
        back: '1. Cohesion & adhesion (hydrogen bonds between water molecules; water–surface bonds)\n2. Temperature moderation (high specific heat; high heat of vaporization)\n3. Ice less dense than liquid water (ice floats; protects aquatic life)\n4. Versatile solvent (dissolves polar and ionic substances)',
      },
      {
        front: 'Why does evaporative cooling work, and why is it important for organisms?',
        back: 'Evaporation of water requires breaking hydrogen bonds → absorbs heat. The highest-energy (hottest) water molecules evaporate first, cooling the remaining liquid.\nImportance: sweating cools mammals; water transpiring from leaves cools plants.',
      },
      {
        front: 'Why is ice less dense than liquid water? What is the ecological significance?',
        back: 'In ice, each water molecule forms 4 hydrogen bonds in a crystal lattice → molecules are held farther apart than in liquid water → lower density.\nEcological significance: ice floats and insulates liquid water below, preventing lakes and ponds from freezing solid and allowing aquatic life to survive winter.',
      },
      {
        front: 'Define pH. What does a change of one pH unit represent?',
        back: 'pH = −log₁₀[H⁺]. Measures hydrogen ion concentration.\nA change of 1 pH unit = a 10× change in [H⁺] (logarithmic scale).\npH 7 = neutral; below 7 = acidic (more H⁺); above 7 = basic (more OH⁻).',
      },
      {
        front: 'What is a buffer, and how does the bicarbonate buffer system work?',
        back: 'Buffer: a substance that minimizes pH changes by accepting or donating H⁺.\nBicarbonate buffer: CO₂ + H₂O ⇌ H₂CO₃ ⇌ H⁺ + HCO₃⁻\nExcess H⁺ → shifts left (absorbed); too basic → shifts right (H⁺ released). Maintains blood pH at 7.35–7.45.',
      },
      {
        front: 'Why is carbon ideal for building the large, complex molecules of life?',
        back: 'Carbon has 4 valence electrons → forms 4 covalent bonds. It can bond to H, O, N, S, and other carbons in chains, branches, and rings, creating enormous structural diversity. Carbon–carbon bonds are stable and allow long polymers.',
      },
      {
        front: 'List the seven major functional groups with their formulas and properties.',
        back: 'Hydroxyl (–OH): polar, H-bonding\nCarbonyl (C=O): polar; ketone or aldehyde\nCarboxyl (–COOH): acidic, donates H⁺\nAmino (–NH₂): basic, accepts H⁺\nSulfhydryl (–SH): forms disulfide bonds\nPhosphate (–OPO₃²⁻): acidic; energy transfer\nMethyl (–CH₃): nonpolar; affects gene regulation',
      },
      {
        front: 'What are structural isomers vs. geometric isomers vs. enantiomers?',
        back: 'Structural isomers: same molecular formula, different covalent arrangements (e.g., glucose vs. fructose, both C₆H₁₂O₆)\nGeometric isomers: same bonds but different spatial arrangement around a double bond (cis vs. trans fats)\nEnantiomers: mirror images (L vs. D forms); only one form is biologically active (stereospecific enzymes)',
      },
      {
        front: 'What is dehydration synthesis? What is hydrolysis? What bonds do they form/break?',
        back: 'Dehydration synthesis (condensation): monomers join by releasing H₂O; forms glycosidic bonds (sugars), peptide bonds (proteins), ester bonds (fats), phosphodiester bonds (nucleic acids).\nHydrolysis: polymer + H₂O → monomers; breaks those same bonds. Digestion is enzymatic hydrolysis.',
      },
      {
        front: 'Why are L-amino acids and D-sugars used in biology instead of their mirror images?',
        back: 'Life uses only L-amino acids and D-sugars (chirality is asymmetric). Enzymes are stereospecific — they have a precise 3D active site that only fits one enantiomer. Using one form ensures consistent molecular interactions and enzyme activity.',
      },
      {
        front: 'What distinguishes a saturated fatty acid from an unsaturated one?',
        back: 'Saturated: all C–C single bonds; maximum H atoms; straight chain → pack tightly → solid at room temperature (animal fats, butter).\nUnsaturated: one or more C=C double bonds; cis configuration creates kinks → cannot pack tightly → liquid at room temperature (plant oils).',
      },
      {
        front: 'What is the difference between hydrophilic and hydrophobic molecules?',
        back: 'Hydrophilic ("water-loving"): polar or charged molecules that interact with water via hydrogen bonds (sugars, amino acids, salts). Dissolve in water.\nHydrophobic ("water-fearing"): nonpolar molecules that do not interact with water (fats, oils, hydrocarbons). Do not dissolve in water; cluster together (hydrophobic effect).',
      },
      {
        front: 'What makes phospholipids amphipathic, and why is this property critical?',
        back: 'Amphipathic: having both hydrophilic and hydrophobic regions.\nPhospholipid: hydrophilic head (phosphate + glycerol) + two hydrophobic fatty acid tails.\nIn water, phospholipids spontaneously form bilayers (heads face water, tails face inward) → the basis of all cell membranes.',
      },
      {
        front: 'What functional groups are on an amino acid, and which is acidic vs. basic?',
        back: 'Every amino acid has:\n• Amino group (–NH₂) → BASIC (accepts H⁺)\n• Carboxyl group (–COOH) → ACIDIC (donates H⁺)\n• R group (side chain) → determines identity and properties\nAmino acids are amphoteric — they can act as acids OR bases.',
      },
      {
        front: 'What are steroids structurally, and what are three biological examples?',
        back: 'Steroids: lipids with four fused carbon rings (not fatty acid chains). Are hydrophobic.\nExamples: cholesterol (membrane component; precursor to steroid hormones), testosterone (male sex hormone), estrogen (female sex hormone), cortisol (stress hormone).',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    cards: [
      {
        front: 'Write the overall equation for aerobic cellular respiration.',
        back: 'C₆H₁₂O₆ + 6O₂ → 6CO₂ + 6H₂O + ~32 ATP\n(Glucose + Oxygen → Carbon dioxide + Water + ATP)',
      },
      {
        front: 'What happens in glycolysis? Where? What are the products?',
        back: 'Location: CYTOPLASM (cytosol); does not require O₂\nProcess: 1 glucose (6C) → 2 pyruvate (3C) in 10 enzymatic steps\nEnergy investment: 2 ATP used\nEnergy payoff: 4 ATP + 2 NADH produced\nNet per glucose: 2 ATP + 2 NADH + 2 pyruvate',
      },
      {
        front: 'What happens in the Krebs cycle? Where? What are the products per glucose?',
      ...
      {
        front: "What is the electron transport chain? Where is it located? What is O₂'s role?",
...
const QUIZ_DECKS_2: Deck[] = [
  {
    ...
    cards: [
      {
        front: 'What is the difference between an incomplete and a complete digestive system?',
        back: 'Incomplete: single opening serves as both mouth and anus (gastrovascular cavity). Examples: cnidarians, flatworms.\nComplete: two separate openings — mouth and anus — allowing simultaneous digestion in specialized regions. Examples: all vertebrates.',
      },
      {
        front: 'Trace the path of food through the human digestive system in order.',
        back: 'Mouth → Pharynx → Esophagus → Stomach → Small intestine (duodenum → jejunum → ileum) → Large intestine (cecum → colon → rectum) → Anus',
      },
      {
        front: 'What are the major pancreatic enzymes and what does each digest?',
        back: 'Pancreatic amylase → starch → maltose\nPancreatic lipase → triglycerides → fatty acids + glycerol\nTrypsin + Chymotrypsin → proteins → peptides\nCarboxypeptidase → peptides → amino acids\nPancreatic nucleases → DNA/RNA → nucleotides\nAll secreted into duodenum; activated by enterokinase (trypsinogen → trypsin activates the rest).',
      },
      {
        front: 'What is the role of bile, where is it produced and stored?',
        back: 'Bile: mixture of bile salts, cholesterol, phospholipids, bilirubin.\nRole: EMULSIFIES fat — breaks large lipid droplets into smaller ones, increasing surface area for lipase. NOT an enzyme.\nProduced: LIVER\nStored: GALLBLADDER\nReleased into duodenum via bile duct when fat is present.',
      },
      {
        front: 'How do villi and microvilli increase nutrient absorption?',
        back: 'Villi: finger-like projections (~1 mm tall); increase SA ~10×\nMicrovilli (brush border): on epithelial cells of villi; increase SA ~20× more\nTogether: ~250–600 m² total absorptive surface\nEach villus: capillaries (absorb amino acids, monosaccharides, water-soluble vitamins) + lacteal (absorbs fats as chylomicrons)',
      },
      {
        front: 'Compare open and closed circulatory systems.',
        back: 'Open: hemolymph bathes tissues directly in body cavities; low pressure; slow delivery. Examples: insects, most mollusks.\nClosed: blood confined to vessels; higher pressure; faster, more precise delivery. Examples: vertebrates, cephalopods, earthworms.',
      },
      {
        front: 'Trace blood flow through the human heart naming all four chambers and valves.',
        back: 'Body → Vena cavae → RIGHT ATRIUM → (Tricuspid valve) → RIGHT VENTRICLE → (Pulmonary semilunar) → Pulmonary arteries → Lungs → Pulmonary veins → LEFT ATRIUM → (Bicuspid/Mitral) → LEFT VENTRICLE → (Aortic semilunar) → Aorta → Body',
      },
      {
        front: 'What is the cardiac conduction system and what is the pacemaker?',
        back: 'SA node (sinoatrial) — PACEMAKER; generates spontaneous AP ~70×/min in right atrium → both atria contract.\nAV node — brief delay (~0.1s); allows atria to finish → Bundle of His → Bundle branches → Purkinje fibers → ventricles contract from apex upward.',
      },
      {
        front: 'Describe the cardiac cycle.',
        back: 'DIASTOLE: all chambers relax and fill.\nATRIAL SYSTOLE: atria contract → push blood into ventricles.\nVENTRICULAR SYSTOLE: ventricles contract → AV valves close (LUB) → blood ejected → semilunar valves close (DUB).\nBlood pressure: systolic/diastolic (normal ~120/80 mmHg).',
      },
      {
        front: 'How do arteries, veins, and capillaries differ?',
        back: 'Arteries: carry blood AWAY from heart; thick elastic walls; high pressure; pulse-able.\nCapillaries: one cell thick; site of O₂, nutrient, waste exchange.\nVeins: carry blood TOWARD heart; thinner walls; valves prevent backflow; low pressure.',
      },
      {
        front: 'What are the four components of blood and their functions?',
        back: 'Plasma (55%): water + proteins + nutrients + hormones + CO₂\nErythrocytes/RBCs (44%): carry O₂ via hemoglobin; no nucleus; 120-day lifespan\nLeukocytes/WBCs (<1%): immune defense\nPlatelets (<1%): fragments of megakaryocytes; initiate clotting',
      },
      {
        front: 'What is blood pressure and what is normal?',
        back: 'Force exerted by blood on vessel walls; reported as systolic/diastolic mmHg.\nNormal: ~120/80 mmHg. Hypertension: consistently >130/80.\nSystolic = ventricles contracting (maximum pressure).\nDiastolic = ventricles relaxed (minimum pressure).',
      },
      {
        front: 'What is the ABO blood typing system based on?',
        back: 'Surface antigens on RBCs:\nType A: A antigen; anti-B antibodies\nType B: B antigen; anti-A antibodies\nType AB: A+B antigens; no antibodies (universal recipient)\nType O: no antigens; anti-A and anti-B antibodies (universal donor)\nMismatched transfusion → agglutination → hemolysis.',
      },
      {
        front: 'What is the lymphatic system and how does it interact with circulation?',
        back: 'Recollects interstitial fluid that leaks from capillaries → lymph → returned to blood via thoracic duct (left subclavian vein) and right lymphatic duct.\nAlso transports dietary fats (chylomicrons from lacteals) and houses lymphocytes (lymph nodes filter pathogens).',
      },
      {
        front: 'What is single vs. double circulation?',
        back: 'Single: blood passes through heart once per body circuit (fish; 2-chambered heart); lower pressure after gills.\nDouble: blood passes through heart twice (pulmonary + systemic circuits); mammals/birds (4-chambered, fully separated) maintain high systemic pressure; amphibians (3-chambered) have some mixing.',
      },
    ],
  },
  {
    ...
    cards: [
      {
        front: 'Trace the pathway of air from the nose to the alveoli.',
        back: 'Nasal cavity → Pharynx → Larynx (epiglottis guards) → Trachea (cartilage rings; ciliated) → Bronchi → Bronchioles (no cartilage) → Terminal bronchioles → Alveolar ducts → Alveoli',
      },
      {
        front: 'Explain pressure changes driving inhalation and exhalation.',
        back: 'Inhalation (ACTIVE): diaphragm contracts + external intercostals lift ribs → thoracic volume INCREASES → lung pressure drops below atmospheric → air flows IN.\nExhalation (PASSIVE at rest): diaphragm relaxes → volume DECREASES → pressure rises → air flows OUT.',
      },
      {
        front: 'Why are alveoli so effective at gas exchange?',
        back: '• Enormous SA (~70 m²)\n• Very thin walls (single epithelial layer, ~0.1 μm)\n• Surrounded by dense capillaries\n• Short diffusion distance (<0.5 μm)\n• Surfactant prevents collapse\n• Moist surface (gases dissolve before diffusing)',
      },
      {
        front: 'What partial pressure gradients drive gas exchange at the lungs?',
        back: 'O₂: alveolar PO₂ (104 mmHg) > venous blood (40 mmHg) → O₂ into blood.\nCO₂: venous PCO₂ (46 mmHg) > alveolar PCO₂ (40 mmHg) → CO₂ out of blood.\nAt tissues: O₂ moves from blood (100 mmHg) to cells (40 mmHg); CO₂ moves from cells (46 mmHg) to blood (40 mmHg).',
      },
      {
        front: 'How does hemoglobin carry O₂ and what is the Bohr effect?',
        back: 'Hb: 4 subunits, each with heme (Fe²⁺); carries up to 4 O₂; cooperative binding → sigmoidal dissociation curve.\nBohr effect: ↑CO₂/↓pH → Hb releases O₂ more readily. Ensures O₂ delivered to metabolically active (acidic) tissues.',
      },
      {
        front: 'How is CO₂ transported in blood?',
        back: '~70% as bicarbonate (HCO₃⁻) in plasma: CO₂ + H₂O → H₂CO₃ → H⁺ + HCO₃⁻ (carbonic anhydrase in RBCs)\n~23% bound to Hb as carbaminohemoglobin\n~7% dissolved in plasma',
      },
      {
        front: 'What are the three forms of nitrogenous waste and which animals produce each?',
        back: 'Ammonia: most toxic, aquatic animals (bony fish, many invertebrates) — needs lots of water.\nUrea: less toxic, mammals/amphibians/sharks — moderate water needed.\nUric acid: least toxic, birds/reptiles/insects — minimal water; paste form.',
      },
      {
        front: 'Describe the nephron structure in order.',
        back: "Glomerulus + Bowman's capsule (filtration) → Proximal convoluted tubule (PCT) → Loop of Henle (descending → ascending) → Distal convoluted tubule (DCT) → Collecting duct → Renal pelvis → Ureter",
      },
      {
        front: 'What are the three processes of urine formation?',
        back: "FILTRATION: blood pressure forces fluid from glomerulus into Bowman's capsule (~180 L/day).\nREABSORPTION: ~99% returned to blood (glucose, amino acids, water, ions; ~178.5 L/day).\nSECRETION: H⁺, K⁺, drugs, toxins actively pumped from blood into tubule.",
      },
      {
        front: 'What is reabsorbed in the proximal convoluted tubule?',
        back: '~65% of filtrate: 100% of glucose and amino acids (active transport; why diabetes → glucosuria), ~65% Na⁺/Cl⁻/K⁺/water, most HCO₃⁻, ~50% urea.',
      },
      {
        front: 'What is the function of the loop of Henle?',
        back: 'Creates osmotic gradient in renal medulla for concentrated urine production.\nDescending limb: water exits (osmosis) → filtrate concentrated.\nAscending limb: NaCl pumped out (impermeable to water) → medulla becomes hypertonic.\nGradient enables water reabsorption from collecting duct.',
      },
      {
        front: 'How does ADH regulate urine concentration?',
        back: 'ADH released when blood osmolarity is high (dehydration).\nEffect: inserts aquaporin-2 channels in collecting duct → more water reabsorbed → concentrated urine, small volume.\nADH absent → no aquaporins → dilute urine, large volume.\nAlcohol inhibits ADH → dehydration.',
      },
      {
        front: "What is aldosterone's role in the kidney?",
        back: 'Released when blood Na⁺ is low or BP is low (via RAAS).\nEffect: ↑Na⁺ reabsorption (+ Na⁺/K⁺ ATPase synthesis) in DCT/collecting duct → water follows → ↑blood volume and BP; ↑K⁺ excretion.',
      },
      {
        front: 'What is countercurrent exchange in the loop of Henle?',
        back: 'Descending and ascending limbs run parallel in opposite directions:\nDescending: water exits → filtrate concentrated.\nAscending: NaCl pumped out → builds medullary concentration gradient.\nPositive feedback: concentrated descending fluid delivers more NaCl to ascending limb → steeper gradient.\nResult: medulla osmolarity up to ~1200 mOsm → concentrated urine possible.',
      },
      {
        front: 'What drives glomerular filtration?',
        back: "BLOOD PRESSURE (hydrostatic pressure) in glomerular capillaries forces fluid into Bowman's capsule.\nOpposed by: colloid osmotic pressure (plasma proteins hold water back) + capsular pressure.\nGFR: ~125 mL/min = ~180 L/day. Proteins and cells NOT filtered (too large + charge barrier).",
      },
    ],
  },
  {
